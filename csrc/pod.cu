...
void pod_with_kv_cache_tensor_impl_(
    ...
    TensorView q_p, TensorView k_p, TensorView v_p, TensorView o_p,
    Optional<TensorView> maybe_lse_p, unsigned int num_qo_heads, unsigned int num_kv_heads,
    ...
    double rope_rcp_scale_p, double rope_rcp_theta_p, TensorView q_d, int64_t page_size_d,
    int64_t batch_size, QKVLayout kv_layout_d, TensorView paged_k_cache_d,
    TensorView paged_v_cache_d, TensorView paged_kv_indices_d, TensorView paged_kv_indptr_d,
    TensorView paged_kv_last_page_len_d, TensorView qo_indptr_d, TensorView o_d,
    Optional<TensorView> maybe_lse_d, int64_t window_left_d,
